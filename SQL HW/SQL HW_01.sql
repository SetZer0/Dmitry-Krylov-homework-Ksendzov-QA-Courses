...
select * from students where created_on='2021-01-26 00:00:00'; 
...
select min(id) as "minimal id" from students;

--29. Вывести максимальный.
select max(id) as "maximal id" from students;

--30. Вывести количество пользователей.
select count(name) as"amount of users" from students; 
